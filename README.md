...
1. 打开设置窗口，进入「通用设置」
2. 在「锁屏外观」卡片中开启「背景图片」
3. 点击「导入图片」按钮选择本地图片（支持 png、jpg、bmp、gif、webp）
